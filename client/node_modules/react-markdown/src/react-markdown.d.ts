...
import uriTransformer = require('react-markdown/src/uri-transformer')
type ReactNode = import('react').ReactNode
type PluggableList = import('unified/types/ts3.4/').PluggableList
type Root = import('hast').Root
type FilterOptions = import('react-markdown/src/rehype-filter').RehypeFilterOptions
type TransformOptions = import('react-markdown/src/ast-to-react').TransformOptions
type CoreOptions = {
  children: string
}
type PluginOptions = {
